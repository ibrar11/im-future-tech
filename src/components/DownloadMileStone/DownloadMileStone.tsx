...
const DownloadMileStone = (props: DownloadMileStoneProps) => {
  ...
  return (
    <div
      className={`flex flex-wrap items-center justify-center gap-x-8 gap-y-3 rounded-xl border-[2px] border-solid border-dark-400 bg-dark-300 px-8 py-5 sm:w-max 2xl:gap-x-12 2xl:p-8 ${styles}`}
    >
