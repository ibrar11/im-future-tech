...
const Button = (props: ButtonProps) => {
  ...
  const primaryButton = btnDisabled
    ...
    : tw`border-2 border-dark-400 text-grey-300 transition-all hover:bg-dark-400 hover:text-grey-500 focus:text-grey-600 focus:ring focus:ring-dark-700 active:bg-dark-300 active:text-grey-400`
  ...
  const secondayButton = btnDisabled
    ...
    : tw`border-2 border-yellow-200 bg-yellow-200 text-dark-200 hover:bg-yellow-300 hover:text-dark-400 focus:text-dark-500 focus:ring focus:ring-yellow-500 active:bg-yellow-300 active:text-dark-300`
